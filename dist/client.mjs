...
var Link = forwardRef(
  ({ children, href, title, className, asChild }, ref) => {
    ...
    const Comp = asChild ? Slot2 : ActiveLink;
    return /* @__PURE__ */ jsx7(Comp, { ref, to: href, className, title, children });
  }
);
...
function Sheet({ ...props }) {
  return /* @__PURE__ */ jsx12(SheetPrimitive.Root, { "data-slot": "sheet", ...props });
}
function SheetTrigger({
  ...props
}) {
  return /* @__PURE__ */ jsx12(SheetPrimitive.Trigger, { "data-slot": "sheet-trigger", ...props });
}
function SheetClose({
  ...props
}) {
  return /* @__PURE__ */ jsx12(SheetPrimitive.Close, { "data-slot": "sheet-close", ...props });
}
...
function SidebarProvider({
  ...
  return /* @__PURE__ */ jsx16(SidebarContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsx16(TooltipProvider, { delayDuration: 0, children: /* @__PURE__ */ jsx16(
    "div",
    {
...
function Sidebar({
  ...
  if (isMobile) {
    return /* @__PURE__ */ jsx16(Sheet, { open: openMobile, onOpenChange: setOpenMobile, ...props, children: /* @__PURE__ */ jsxs7(
      SheetContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs7(SheetHeader, { className: "sr-only", children: [
            /* @__PURE__ */ jsx16(SheetTitle, { children: "Sidebar" }),
            /* @__PURE__ */ jsx16(SheetDescription, { children: "Displays the mobile sidebar." })
          ] }),
          /* @__PURE__ */ jsx16("div", { className: "flex h-full w-full flex-col", children })
        ]
      }
    ) });
  }
...
function SidebarTrigger({
  ...
  return /* @__PURE__ */ jsxs7(
    Button,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx16(PanelLeftIcon, {}),
        /* @__PURE__ */ jsx16("span", { className: "sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
}
...
function SidebarMenuButton({
  ...
  return /* @__PURE__ */ jsxs7(Tooltip, { children: [
    /* @__PURE__ */ jsx16(TooltipTrigger, { asChild: true, children: button }),
    /* @__PURE__ */ jsx16(
      TooltipContent,
      {
        side: "right",
...
function AppSidebar({
  ...
  return /* @__PURE__ */ jsxs9(Sidebar, { collapsible: "icon", ...props, children: [
    ...
    /* @__PURE__ */ jsx18(SidebarContent, { children: /* @__PURE__ */ jsx18(NavRefine, { groupLabels: labels }) }),
